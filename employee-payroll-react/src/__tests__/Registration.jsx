...
describe("Employee Registration Testing", () => {
  ...
  test("shows success toast on successful submission", async () => {
    ...
    fireEvent.click(screen.getByDisplayValue("img1.jpg")); // Select profile image
    fireEvent.click(screen.getByDisplayValue("male")); // Select gender
    fireEvent.click(screen.getByDisplayValue("HR")); // Select department
